...
import QImageViewOverlay from './QImageViewOverlay';

export default class QImageView extends Component {
  static propTypes = {
  ...
  render() {
    ...
    return (
      ...
      >
        ...
        {this.props.navigator ? false : <QImageViewOverlay {...this.getOverlayProps()} />}
      </View>
    );
  }
}
